...
class CgiPicDownload: public MainCgi
{
     public:
        CgiPicDownload() : MainCgi(0, "config.ini", "logger.properties", CGI_NEED_LOGIN_NO)
        {
    ...
    //image/png
		...
		bool InnerProcess()
		{
			...
			{
				Return403();
				LOG4CPLUS_ERROR(logger, "no previledges, stCommonPicture is private pic, please use download_private to get pic data");
				return true;
			}
