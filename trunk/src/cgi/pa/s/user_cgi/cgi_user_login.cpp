...
public:
	...
	bool InnerProcess()
	{
		...
		pSMsgReq->set_sub_cmd(::hoosho::msg::s::USER_LOGIN_REQ);
		...
		if(stSMsgRes.sub_cmd() != ::hoosho::msg::s::USER_LOGIN_RES)
		{
			DoReply(CGI_RET_CODE_SERVER_BUSY);
		...
		//5.feedback
		const ::hoosho::msg::s::UserInfo& stUserInfo = stSMsgRes.user_info_list(0);
		GetAnyValue()["user_info"] = UserInfoPB2Any(stUserInfo);
