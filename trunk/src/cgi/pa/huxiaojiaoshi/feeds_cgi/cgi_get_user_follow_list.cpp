...
class CgiGetUserFollowList: public CgiFeedsBase
{
public:
	CgiGetUserFollowList():
	...
	bool InnerProcess()
	{
		...
		if(!FetchFeedInfo(m_feeds_server_ip, m_feeds_server_port, vecFeedId, "0", qwErrcode, strErrMsg, vecFeedInfo)
