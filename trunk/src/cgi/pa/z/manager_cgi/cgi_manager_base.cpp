...
bool CgiManagerBase::DerivedInit()
{
	...
	GetConfig().GetValue("DB", "table_name_user_extra_info", m_table_name_user_extra_info, "");
	GetConfig().GetValue("DB", "table_name_order_info", m_table_name_order_info, "");
	GetConfig().GetValue("DB", "table_name_user_info", m_table_name_user_info, "");
	GetConfig().GetValue("DB", "table_name_outcome_req", m_table_name_outcome_req, "");
