...
{
	GetConfig().GetValue("msg_server", "ip", msgServerIP, "");
	GetConfig().GetValue("msg_server", "port", msgServerPort, 0);
	GetConfig().GetValue("user_server", "ip", userServerIP, "");
	GetConfig().GetValue("user_server", "port", userServerPort, 0);
	GetConfig().GetValue("feed_server", "ip", feedServerIP, "");
	GetConfig().GetValue("feed_server", "port", feedServerPort, 0);
