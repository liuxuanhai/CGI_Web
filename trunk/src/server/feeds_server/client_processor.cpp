...
void ClientProcessor::process_input(lce::net::ConnectionInfo& conn, lce::net::IDatagram& ogram )
{
	...
	if(dwReqType == hoosho::msg::QUERY_FEED_DETAIL_REQ 
		|| dwReqType == hoosho::msg::QUERY_FEED_REQ 
		|| dwReqType == hoosho::msg::ADD_FEED_REQ 
		|| dwReqType == hoosho::msg::DELETE_FEED_REQ
		|| dwReqType == hoosho::msg::ADD_REPORT_FEED_REQ
		|| dwReqType == hoosho::msg::QUERY_USER_FORBID_REQ)
	{
		FsmFeed* fsm = g_fsm_feed_container->new_fsm();
	...
	else if(dwReqType == hoosho::msg::QUERY_FOLLOW_DETAIL_REQ
		|| dwReqType == hoosho::msg::QUERY_FOLLOW_LIST_REQ
		|| dwReqType == hoosho::msg::QUERY_FOLLOW_COMMENT_DETAIL_REQ
		|| dwReqType == hoosho::msg::QUERY_FOLLOW_COMMENT_REQ 
		|| dwReqType == hoosho::msg::ADD_FOLLOW_REQ 
		|| dwReqType == hoosho::msg::DELETE_FOLLOW_REQ)
	{
	...
	else if(dwReqType == hoosho::msg::QUERY_FEED_LIST_FAVORITE_REQ
		|| dwReqType == hoosho::msg::QUERY_FAVORITE_REQ 
		|| dwReqType == hoosho::msg::ADD_FAVORITE_REQ 
		|| dwReqType == hoosho::msg::DELETE_FAVORITE_REQ)
	{
	
		FsmFavorite *fsm = g_fsm_favorite_container->new_fsm();
	...
	else if(dwReqType == hoosho::msg::QUERY_FEED_LIST_COLLECT_REQ
		|| dwReqType == hoosho::msg::QUERY_COLLECT_REQ 
		|| dwReqType == hoosho::msg::ADD_COLLECT_REQ 
		|| dwReqType == hoosho::msg::DELETE_COLLECT_REQ)
	{
	
		FsmCollect *fsm = g_fsm_collect_container->new_fsm();
	...
	{
		LOG4CPLUS_ERROR(logger, "unknown reqtype = " << dwReqType);
		return;
	}
