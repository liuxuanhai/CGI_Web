#ifndef _HOOSHO_FEEDS_SERVER_SERVER_MESSAGE_PROCESSOR_MSG_H_
#define _HOOSHO_FEEDS_SERVER_SERVER_MESSAGE_PROCESSOR_MSG_H_
...
public:
	...
	void process_delete_notice_reply(lce::net::ConnectionInfo& conn, const ::hoosho::msg::Msg& msg);
