#ifndef _HOOSHO_J_USER_SERVER_FSM_STATE_BUSINESS_H_
#define _HOOSHO_J_USER_SERVER_FSM_STATE_BUSINESS_H_
...
public:
	virtual void client_req_event(FsmBusiness& fsm, lce::net::ConnectionInfo& conn, const ::hoosho::msg::Msg& msg);
