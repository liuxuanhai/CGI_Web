#ifndef _HOOSHO_J_FEEDS_SERVER_TOKEN_SERVER_MESSAGE_PROCESSOR_H_
#define _HOOSHO_J_FEEDS_SERVER_TOKEN_SERVER_MESSAGE_PROCESSOR_H_
...
class ServerProcessorToken : public lce::net::IMessageProcessor
{
public:
	ServerProcessorToken();
	~ServerProcessorToken();
