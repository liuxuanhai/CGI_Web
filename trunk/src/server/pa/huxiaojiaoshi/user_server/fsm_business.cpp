...
#define CASE_CMD_REQ_RES(reqcmd, rescmd) \
	case reqcmd: \
		...
		CASE_CMD_REQ_RES(::hoosho::msg::J_USER_LOGIN_REQ, ::hoosho::msg::J_USER_LOGIN_RES);
		CASE_CMD_REQ_RES(::hoosho::msg::J_GET_USER_INFO_REQ, ::hoosho::msg::J_GET_USER_INFO_RES);
		CASE_CMD_REQ_RES(::hoosho::msg::J_UPDATE_USER_INFO_REQ, ::hoosho::msg::J_UPDATE_USER_INFO_RES);
