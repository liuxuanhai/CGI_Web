#ifndef _CLIENT_PROCESSOR_H_
#define _CLIENT_PROCESSOR_H_
...
public:
	...
	{
	public:
		hoosho::msg::s::UserInfo _user_info;
		uint64_t _expire_ts;
		...
		LoginSessionInfo(const hoosho::msg::s::UserInfo& stUserInfo, uint64_t qwExpireTS)
	...
	void add_login_session(const std::string& strAuthCode, const hoosho::msg::s::UserInfo& stUserInfo, uint64_t qwExpireTs = 0);
	int check_login_session(const std::string& strAuthCode, hoosho::msg::s::UserInfo& stUserInfo);
